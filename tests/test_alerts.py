...
from stock_analyzer.alerts.monitor import Alert, AlertMonitor, AlertRule
from stock_analyzer.alerts.notifier import AlertNotifier, NotificationRecord
...
class TestAlertNotifier:
    ...
    def test_webhook_send_with_mock(self):
        ...
        with patch("stock_analyzer.alerts.notifier.requests.post") as mock_post:
